...
accessibility.par02 = This service is part of the wider GOV.UK website. There''s a separate
accessibility.par02.linkText = accessibility statement for the main GOV.UK website
...
accessibility.par04 = You can use this service to see how to claim a refund if you paid HMRC too much tax - for example on your pay, a redundancy payment, or interest from your savings.
accessibility.par05 = This service is run by HM Revenue & Customs (HMRC). We want as many people as possible to be able to use this service. For example, that means you should be able to:
...
accessibility.par06 = We''ve also made the text in the service as simple as possible to understand.
...
accessibility.par09 = We''re always looking to improve the accessibility of this service. If you find any problems that are not listed on this page or think we are not meeting accessibility requirements, please report the accessibility problem to us by email on
accessibility.par09.linkText = hmrc-accessibility-problems@digital.hmrc.gov.uk
...
accessibility.par15 = This service is partially compliant with the
...
accessibility.par21 = The service was last tested on 30 August 2019 and was checked for compliance with WCAG 2.1 AA. The test was carried out by our own testers.
