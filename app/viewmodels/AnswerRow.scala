...
case class AnswerRow(label: Message, answer: Message, url: String, deleteUrl: Option[String], itemName: Option[String], isHeadingRow: Boolean, isDeleteLinkRow: Boolean)
