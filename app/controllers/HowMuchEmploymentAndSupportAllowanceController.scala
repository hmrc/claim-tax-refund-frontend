...
class HowMuchEmploymentAndSupportAllowanceController @Inject()(
                                        ...
                                        formBuilder: HowMuchEmploymentAndSupportAllowanceForm) extends FrontendController with I18nSupport {

  private val form: Form[String] = formBuilder()

  def onPageLoad(mode: Mode) = (authenticate andThen getData andThen requireData) {
    implicit request =>
      val preparedForm = request.userAnswers.howMuchEmploymentAndSupportAllowance match {
        case None => form
