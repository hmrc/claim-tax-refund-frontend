...
import identifiers.HowMuchRentalIncomeId
import models.Mode
...
class HowMuchRentalIncomeController @Inject()(
                                        ...
                                        formBuilder: HowMuchRentalIncomeForm) extends FrontendController with I18nSupport {

  private val form: Form[String] = formBuilder()

  def onPageLoad(mode: Mode) = (authenticate andThen getData andThen requireData) {
    implicit request =>
      val preparedForm = request.userAnswers.howMuchRentalIncome match {
        case None => form
