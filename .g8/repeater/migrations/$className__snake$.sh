...
echo "GET        /$pluralName;format="decap"$/overview                     controllers.$pluralName;format="lower"$.$className$OverviewController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "" >> ../conf/app.routes
echo "GET        /$pluralName;format="decap"$/add                          controllers.$pluralName;format="lower"$.Add$className$Controller.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /$pluralName;format="decap"$/add                          controllers.$pluralName;format="lower"$.Add$className$Controller.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "" >> ../conf/app.routes
echo "GET        /any$pluralName$                                          controllers.$pluralName;format="lower"$.Any$pluralName$Controller.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /any$pluralName$                                          controllers.$pluralName;format="lower"$.Any$pluralName$Controller.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "" >> ../conf/app.routes
echo "GET        /$pluralName;format="decap"$/:index/change                controllers.$pluralName;format="lower"$.Edit$className$Controller.onPageLoad(index: Int, mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /$pluralName;format="decap"$/:index/change                controllers.$pluralName;format="lower"$.Edit$className$Controller.onSubmit(index: Int, mode: Mode = NormalMode)" >> ../conf/app.routes
echo "" >> ../conf/app.routes
echo "GET        /$pluralName;format="decap"$/:index/remove                controllers.$pluralName;format="lower"$.Delete$className$Controller.onPageLoad(index: Int, mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /$pluralName;format="decap"$/:index/remove                controllers.$pluralName;format="lower"$.Delete$className$Controller.onSubmit(index: Int, mode: Mode = NormalMode)" >> ../conf/app.routes

echo "" >> ../conf/app.routes
echo "GET        /change$pluralName$/overview               controllers.$pluralName;format="lower"$.$className$OverviewController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "" >> ../conf/app.routes
echo "GET        /change$pluralName$/add                    controllers.$pluralName;format="lower"$.Add$className$Controller.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /change$pluralName$/add                    controllers.$pluralName;format="lower"$.Add$className$Controller.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "" >> ../conf/app.routes
echo "GET        /changeAny$pluralName$                     controllers.$pluralName;format="lower"$.Any$pluralName$Controller.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeAny$pluralName$                     controllers.$pluralName;format="lower"$.Any$pluralName$Controller.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "" >> ../conf/app.routes
echo "GET        /change$pluralName$/:index/change          controllers.$pluralName;format="lower"$.Edit$className$Controller.onPageLoad(index: Int, mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /change$pluralName$/:index/change          controllers.$pluralName;format="lower"$.Edit$className$Controller.onSubmit(index: Int, mode: Mode = CheckMode)" >> ../conf/app.routes
echo "" >> ../conf/app.routes
echo "GET        /change$pluralName$/:index/remove          controllers.$pluralName;format="lower"$.Delete$className$Controller.onPageLoad(index: Int, mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /change$pluralName$/:index/remove          controllers.$pluralName;format="lower"$.Delete$className$Controller.onSubmit(index: Int, mode: Mode = CheckMode)" >> ../conf/app.routes
...
awk '/controllers.routes/ {\
     print;\
     print "import controllers.$pluralName;format="decap"$.{routes => $className;format="decap"$Routes}";\
