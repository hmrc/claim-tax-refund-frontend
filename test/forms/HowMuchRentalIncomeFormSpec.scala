...
class HowMuchRentalIncomeFormSpec extends FormBehaviours with MockitoSugar {

  private val testRegex = """(?=.)^\$?(([1-9][0-9]{0,2}(,[0-9]{3})*)|[0-9]+)?(\.[0-9]{1,2})?$"""
  private val errorKeyInvalid = "howMuchRentalIncome.invalid"
  private val errorKeyBlank = "howMuchRentalIncome.blank"
  ...
  override val form: Form[_] = new HowMuchRentalIncomeForm(appConfig)()

  "HowMuchRentalIncome Form" must {
