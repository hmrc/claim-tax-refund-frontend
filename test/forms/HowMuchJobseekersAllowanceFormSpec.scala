...
class HowMuchJobseekersAllowanceFormSpec extends FormBehaviours with MockitoSugar {

  private val testRegex = """(?=.)^\$?(([1-9][0-9]{0,2}(,[0-9]{3})*)|[0-9]+)?(\.[0-9]{1,2})?$"""
  private val errorKeyInvalid = "howMuchJobseekersAllowance.invalid"
  private val errorKeyBlank = "howMuchJobseekersAllowance.blank"
  ...
  override val form: Form[_] = new HowMuchJobseekersAllowanceForm(appConfig)()

  "HowMuchJobseekersAllowance Form" must {
