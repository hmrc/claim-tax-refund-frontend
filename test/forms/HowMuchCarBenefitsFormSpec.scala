...
class HowMuchCarBenefitsFormSpec extends FormBehaviours with MockitoSugar {

  private val testRegex = """(?=.)^\$?(([1-9][0-9]{0,2}(,[0-9]{3})*)|[0-9]+)?(\.[0-9]{1,2})?$"""
  private val errorKeyInvalid = "howMuchCarBenefits.invalid"
  private val errorKeyBlank = "howMuchCarBenefits.blank"
  ...
  override val form: Form[_] = new HowMuchCarBenefitsForm(appConfig)()

  "HowMuchCarBenefits Form" must {
