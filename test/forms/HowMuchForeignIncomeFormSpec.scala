...
class HowMuchForeignIncomeFormSpec extends FormBehaviours with MockitoSugar {

  private val testRegex = """(?=.)^\$?(([1-9][0-9]{0,2}(,[0-9]{3})*)|[0-9]+)?(\.[0-9]{1,2})?$"""
  private val errorKeyInvalid = "howMuchForeignIncome.invalid"
  private val errorKeyBlank = "howMuchForeignIncome.blank"
  ...
  override val form: Form[_] = new HowMuchForeignIncomeForm(appConfig)()

  "HowMuchForeignIncome Form" must {
