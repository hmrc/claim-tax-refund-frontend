...
class HowMuchIncapacityBenefitFormSpec extends FormBehaviours with MockitoSugar {

  private val testRegex = """(?=.)^\$?(([1-9][0-9]{0,2}(,[0-9]{3})*)|[0-9]+)?(\.[0-9]{1,2})?$"""
  private val errorKeyInvalid = "howMuchIncapacityBenefit.invalid"
  private val errorKeyBlank = "howMuchIncapacityBenefit.blank"
  ...
  override val form: Form[_] = new HowMuchIncapacityBenefitForm(appConfig)()

  "HowMuchIncapacityBenefit Form" must {
