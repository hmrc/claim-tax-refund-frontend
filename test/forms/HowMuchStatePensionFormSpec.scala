...
class HowMuchStatePensionFormSpec extends FormBehaviours with MockitoSugar {

  private val testRegex = """(?=.)^\$?(([1-9][0-9]{0,2}(,[0-9]{3})*)|[0-9]+)?(\.[0-9]{1,2})?$"""
  private val errorKeyInvalid = "howMuchStatePension.invalid"
  private val errorKeyBlank = "howMuchStatePension.blank"
  ...
  override val form: Form[_] = new HowMuchStatePensionForm(appConfig)()

  "HowMuchStatePension Form" must {
