...
class PartialClaimAmountFormSpec extends FormBehaviours with MockitoSugar {
  ...
  override val form: Form[_] = new PartialClaimAmountForm(appConfig)()

  "PartialClaimAmount Form" must {
