...
class HowMuchFuelBenefitFormSpec extends FormBehaviours with MockitoSugar {

  private val testRegex = """(?=.)^\$?(([1-9][0-9]{0,2}(,[0-9]{3})*)|[0-9]+)?(\.[0-9]{1,2})?$"""
  private val errorKeyInvalid = "howMuchFuelBenefit.invalid"
  private val errorKeyBlank = "howMuchFuelBenefit.blank"
  ...
  override val form: Form[_] = new HowMuchFuelBenefitForm(appConfig)()

  "HowMuchFuelBenefit Form" must {
