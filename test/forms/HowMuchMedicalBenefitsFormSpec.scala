...
class HowMuchMedicalBenefitsFormSpec extends FormBehaviours with MockitoSugar {

  private val testRegex = """(?=.)^\$?(([1-9][0-9]{0,2}(,[0-9]{3})*)|[0-9]+)?(\.[0-9]{1,2})?$"""
  private val errorKeyInvalid = "howMuchMedicalBenefits.invalid"
  private val errorKeyBlank = "howMuchMedicalBenefits.blank"
  ...
  override val form: Form[_] = new HowMuchMedicalBenefitsForm(appConfig)()

  "HowMuchMedicalBenefits Form" must {
