...
class HowMuchEmploymentAndSupportAllowanceFormSpec extends FormBehaviours with MockitoSugar {

  private val testRegex = """(?=.)^\$?(([1-9][0-9]{0,2}(,[0-9]{3})*)|[0-9]+)?(\.[0-9]{1,2})?$"""
  private val errorKeyInvalid = "howMuchEmploymentAndSupportAllowance.invalid"
  private val errorKeyBlank = "howMuchEmploymentAndSupportAllowance.blank"
  ...
  override val form: Form[_] = new HowMuchEmploymentAndSupportAllowanceForm(appConfig)()

  "HowMuchEmploymentAndSupportAllowance Form" must {
