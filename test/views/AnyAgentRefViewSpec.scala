...
class AnyAgentRefViewSpec extends YesNoViewBehaviours {
  ...
  "AnyAgentRef view" must {
    ...
    behave like yesNoPage(createViewUsingForm, messageKeyPrefix, routes.AnyAgentRefController.onSubmit(NormalMode).url)
  }
}
