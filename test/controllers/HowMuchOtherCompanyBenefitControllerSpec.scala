...
class HowMuchOtherCompanyBenefitControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) = howMuchOtherCompanyBenefit(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
  ...
  "HowMuchOtherCompanyBenefit Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(HowMuchOtherCompanyBenefitId.toString -> JsString(testAnswer))
