...
class OtherCompanyBenefitsDetailsControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) = otherCompanyBenefitsDetails(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
  ...
  "OtherCompanyBenefitsDetails Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(OtherCompanyBenefitsDetailsId.toString -> JsString(testAnswer))
