...
class DeleteOtherControllerSpec extends ControllerSpecBase {
  ...
  "DeleteOther Controller" must {
    ...
    "redirect to AnyOtherBenefitsController when value is true and valid benefit submitted" in {
    ...
    "redirect to AnyOtherBenefitsController when valid data is submitted and value is false" in {
