...
class AnyOtherTaxableIncomeControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) = anyOtherTaxableIncome(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
  ...
  "AnyOtherTaxableIncome Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(AnyOtherTaxableIncomeId.toString -> JsBoolean(true))
