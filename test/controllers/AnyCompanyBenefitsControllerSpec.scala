...
class AnyCompanyBenefitsControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) = anyCompanyBenefits(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
  ...
  "AnyCompanyBenefits Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(AnyCompanyBenefitsId.toString -> JsBoolean(true))
