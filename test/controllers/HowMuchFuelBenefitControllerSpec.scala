...
class HowMuchFuelBenefitControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) = howMuchFuelBenefit(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
  ...
  "HowMuchFuelBenefit Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(HowMuchFuelBenefitId.toString -> JsString(testAnswer))
