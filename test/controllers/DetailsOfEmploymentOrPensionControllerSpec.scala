...
class DetailsOfEmploymentOrPensionControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) = detailsOfEmploymentOrPension(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
  ...
  "DetailsOfEmploymentOrPension Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(DetailsOfEmploymentOrPensionId.toString -> JsString(testAnswer))
