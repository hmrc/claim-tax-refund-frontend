...
class HowMuchOtherBenefitControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) = howMuchOtherBenefit(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
  ...
  "HowMuchOtherBenefit Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(HowMuchOtherBenefitId.toString -> JsString(testAnswer))
