...
awk '/class/ {\
     print;\
     print "  def employmentDetails: Option[Boolean] = cacheMap.getEntry[Boolean](EmploymentDetailsId.toString)";\
     print "";\
...
awk '/class/ {\
     ...
     print "    x => AnswerRow(\"employmentDetails.checkYourAnswersLabel\", if(x) \"site.yes\" else \"site.no\", true, routes.EmploymentDetailsController.onPageLoad(CheckMode).url)"; print "  }";\
