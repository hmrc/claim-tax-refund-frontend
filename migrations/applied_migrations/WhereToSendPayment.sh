...
echo "whereToSendPayment.option1 = whereToSendPayment" Option 1 >> ../conf/messages.en
echo "whereToSendPayment.option2 = whereToSendPayment" Option 2 >> ../conf/messages.en
...
awk '/class/ {\
     print;\
     print "  def whereToSendPayment: Option[WhereToSendPayment] = cacheMap.getEntry[WhereToSendPayment](WhereToSendPaymentId.toString)";\
     print "";\
...
awk '/class/ {\
     ...
     print "    x => AnswerRow(\"whereToSendPayment.checkYourAnswersLabel\", s\"whereToSendPayment.$x\", true, routes.WhereToSendPaymentController.onPageLoad(CheckMode).url)";\
     print "  }";\
